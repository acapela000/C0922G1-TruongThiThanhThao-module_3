...
insert into products values (1,'A1','Oppo',400,5,'second-hand','sold-out');
insert into products values (2,'A2','Blackberrry',300,3,'new','on sales');
insert into products values (3,'A3','Sony Ericson',500,4,'second-hand','on sales');
insert into products values (4,'A4','iPhone',600,2,'second-hand','sold-out');
insert into products values (5,'A5','Motorola',800,1,'new','on sales');
insert into products values (6,'A6','Xiaomi',700,5,'new','on sales');
insert into products values (7,'A7','iPhone',900,2,'second-hand','on sales');
------------------------------------------------------------------------------------
...
where product_name = 'Blackberrry';
select * from products;

-- Tiến hành xoá view
delete from view_products where product_name = 'iPhone' and product_code = 'A4';
------------------------------------------------------------------------------------
...
begin
insert into products values ('A8','GalaxySS',1000,3,'new','checking');
end $$
delimiter ;
...
delimiter ;
call edit_product_by_id(1,'B3','LG Promax',700,6,'new','importing');
